...
df = pd.DataFrame(
    # valores aleatorios de 0 a 10 con tamaño de 10 columnas y 2 filas
...
# pasamos la columna en especial que queremos traer los valores con el rango de indices que queremos
